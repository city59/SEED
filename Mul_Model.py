...
class Model():
    ...
    def trainEpoch(self):
        ...
        for user, item_i, item_j in tqdm(train_loader):
            ...
            with t.no_grad():
                user_embed1, item_embed1, user_embeds1, item_embeds1, user_embeds2, item_embeds2, user_embeds3, item_embeds3 = self.Kg_model.getAll()
    ...
    def sampleTestBatch(self, batch_user_id, batch_item_id):
        ...
        tmplen = (batch * 100)
        batch_user_id_np = batch_user_id.cpu().numpy()
