...
class KGDataset(Dataset):
    def __init__(self, m_item, kg_path='./datasets/' + Kg_Par.dataset + '/kg.txt'):
        ...
        self.kg_dict, self.heads, self.kg_dict_subgraph_1, self.heads_subgraph_1, self.kg_dict_subgraph_2, self.heads_subgraph_2, self.kg_dict_subgraph_3, self.heads_subgraph_3 = self.generate_kg_data(
    ...
    def get_kg_dict(self, kg_dict, item_num):
    ...
    def generate_kg_data(self, kg_data):
        ...
        kg_dict_subgraph_1 = collections.defaultdict(list)
        kg_dict_subgraph_2 = collections.defaultdict(list)
        kg_dict_subgraph_3 = collections.defaultdict(list)
        ...
        for row in kg_data.iterrows():
            ...
            if r == 0 or r == 1 or r == 2 or r == 3 or r == 4:
                kg_dict_subgraph_1[h].append((r, t))
            if r == 1 or r == 2 or r == 3 or r == 4 or r == 5:
                kg_dict_subgraph_2[h].append((r, t))
            if r == 1 or r == 2 or r == 0 or r == 4 or r == 5:
                kg_dict_subgraph_3[h].append((r, t))

        heads = list(kg_dict.keys())
        heads_subgraph_1 = list(kg_dict_subgraph_1.keys())
        heads_subgraph_2 = list(kg_dict_subgraph_2.keys())
        heads_subgraph_3 = list(kg_dict_subgraph_3.keys())
        return kg_dict, heads, kg_dict_subgraph_1, heads_subgraph_1, kg_dict_subgraph_2, heads_subgraph_2, kg_dict_subgraph_3, heads_subgraph_3
